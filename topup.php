					...
					<div id="card" class="collapse " data-parent="#topupList">
						<div class="card-body border-bottom">
							<form action="/topup.php?act=card" method="post">
								...
								<div class="form-group">
									<label class="font-weight-bolder" for="ref_code_card">Mã giới thiệu</label>
									<input type="text" name="ref_code" class="form-control " id="ref_code_card" value="" placeholder="Mã giới thiệu (nếu có)">
								</div>
